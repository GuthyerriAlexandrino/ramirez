...
class SpecializationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialization" do
    assert_difference("Specialization.count") do
      post specializations_url, params: { specialization: { name: @specialization.name, string: @specialization.string } }, as: :json
    end
  ...
  test "should update specialization" do
    patch specialization_url(@specialization), params: { specialization: { name: @specialization.name, string: @specialization.string } }, as: :json
    assert_response :success
  end
